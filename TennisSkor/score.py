...
class Match:
    ...
    # def update_serve_pct(self, player):
    #     first_pct = (
    #         player.firstservewin / player.firstservetotal * 100
    #         if player.firstservetotal else 0
    #     )
    #     second_total = player.totalservice - player.firstservetotal
    #     second_pct = (
    #         player.secondservewin / second_total * 100
    #         if second_total else 0
    #     )
        
    #     player.firstservewin_pct = f"{first_pct:.0f}%"
    #     player.secondservewin_pct = f"{second_pct:.0f}%"        
    ...
    def serve_types(self, serve_type):
        ...
        if serve_type == "first":
            ...
            print(f"Total serve pertama : {self.current_server.firstservetotal}")
        else:
    ...
    def get_score(self):
        ...
        key: {
            ...
            "firstservewin_pct": self.calc_pct(p.firstservewin, p.firstservetotal),
            "secondservewin_pct":self.calc_pct(p.secondservewin, p.secondservetotal),
            "bpwin": self.calc_pct(p.breakpointwon, p.breakpoint),
